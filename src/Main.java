public class Main {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("Bambang", "Duren Sawit no. 15"); // super.toString() Method will be called in
																			// the instance of object creation.
		student1.addCourseGrade("Math", 2);
		student1.setAddress("Tanjung Priok no. 105A"); // Use setAddress method from superclass Person to add new
														// address to object;
		student1.addCourseGrade("History", 5);
		student1.printGrades(); // Will return list of course and grade for the course and will return "(Student
								// name) don't have any grade yet if no course/grade added.
		...
		Teacher teacher1 = new Teacher("Oemar Bakri", "Gg. Jambu no. 10"); // super.toString() Method will be called in
																			// the instance of object creation.
		...
		System.out.println(teacher1.removeCourse("Math")); // Will return false as Course Math no longer exist to be
															// removed.
